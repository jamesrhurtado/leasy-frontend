...
.blockHeaderApp{
    ...
    background: #ffffff;
    border:none;
    box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);/*delete*/
    transition: top 1s;
}
...
.blockLeasy,.blockControl{display: flex; align-items: center; gap: 20px;}

.controlApp{background: #fff; padding: 12px; border-radius: 10px;}
.controlApp:hover{background: rgb(248, 248, 248); padding: 12px; border-radius: 10px;}
